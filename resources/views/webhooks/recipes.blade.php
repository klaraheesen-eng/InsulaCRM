                                ...
                                <ol class="mb-0">
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <div class="bg-light p-2 rounded mt-1">
                                            <code>Deal "{{'{{'}}data.title{{'}}'}}" moved to {{'{{'}}data.new_stage{{'}}'}} (was {{'{{'}}data.old_stage{{'}}'}}). Contract price: {{ Fmt::currencySymbol() }}{{'{{'}}data.contract_price{{'}}'}}</code>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <ol class="mb-0">
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <ul class="mt-1">
                                            ...
                                            <li>{{ __('Description:') }} <code>{{ __('Contract Price:') }} {{ Fmt::currencySymbol() }}{{'{{'}}data.contract_price{{'}}'}}</code></li>
