        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <input type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $lead->phone) }}" placeholder="{{ __('072 123 4567') }}">
                    @error('phone') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3">
                    <label class="form-label">{{ __('Secondary Phone') }}</label>
                    <input type="tel" name="secondary_phone" class="form-control @error('secondary_phone') is-invalid @enderror" value="{{ old('secondary_phone', $lead->secondary_phone) }}" placeholder="{{ __('Optional second number') }}">
